...
- 🔬 [Numpy & Pandas | 데이터분석](./데이터분석/)
    - ✍️ [데이터분석_class](./데이터분석/데이터분석%20class/)
        - 1️⃣ [01_numpy](./데이터분석/데이터분석%20class/01_numpy.ipynb)
        - 2️⃣-1️⃣ [02_pandas1](./데이터분석/데이터분석%20class/02_pandas1.ipynb)
        - 2️⃣-2️⃣ [02_pandas2](./데이터분석/데이터분석%20class/02_pandas2.ipynb)
        - 2️⃣-3️⃣ [02_pandas3](./데이터분석/데이터분석%20class/02_pandas3.ipynb)
        - 3️⃣ [03_data_load](./데이터분석/데이터분석%20class/03_data_load.ipynb)
        - 4️⃣ [04_data_cleaning](./데이터분석/데이터분석%20class/04_data_cleaning.ipynb)
        - 4️⃣ [04_kpi](./데이터분석/데이터분석%20class/04_kpi.ipynb)
        - 5️⃣ [05_eda](./데이터분석/데이터분석%20class/05_eda.ipynb)
        - 6️⃣ [06_corr](./데이터분석/데이터분석%20class/06_corr.ipynb)
