...
-- Seq Scan on large_customers  (cost=0.00..3746.00 rows=10083 width=159byte)
-- cost = 점수 (낮을 수록 좋음) / rows * width = 총 메모리 사용량 (SELECT 10013 * 159 / 1024)
...
-- Seq Scan on large_customers  (cost=0.00..3746.00 rows=10083 width=159)
-- 인덱스 없고
-- 테이블 대부분의 행을 읽어야 하고
-- 순차 스캔이 빠를 때
